//
// Created by Branislav on 12/12/2015.
//

#include "scene.h"
#include "explosion.h"

#include "explosion_vert_shader.h"
#include "explosion_frag_shader.h"
...
Explosion::Explosion() {
  ...
  if (!shader) shader = ShaderPtr(new Shader{explosion_vert_shader, explosion_frag_shader});
